    ...
    a.jqx.createRenderer = function(c, e) {
        ...
        setTimeout(function(){
         ...
         //    });
	        ...
	        // $('#chartContainer1').find('.jqx-chart-legend-text').each(function(){
	        //     if($(this).attr('opacity')=='0.5'){
	        //     	$(this).css({'display':'none'});
	        //         // $(this).attr({'cursor':'','x':'130','y':'295'});
	        //         // $(this).css({'cursor':'pointer','color':'blue','font-size': '18px ','font-weight':'700'});
	        //         // $(this).html('<a href="/matrix" style="color:blue;text-decoration: none;outline: 0;">View</a>');
	        //     }
	              
	        // });

	        $('#chartContainer1').find('.jqx-chart-title-text').each(function(){
				$(this).html("Resource Matrix ( <a class='view_btn' href='/matrix' style='cursor:pointer;color:blue;text-decoration: none;outline: 0;'>View</a> )");   
	        });
