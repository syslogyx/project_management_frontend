...
(function(a) {
    ...
    a.extend(a.jqx._jqxChart.prototype, {
        ...
        _defaultSettings: {
            ...
            backgroundColor: "none",        //Suvrat Issue#2817 to fix dashboard charts
            showBorderLine: true,
            // borderLineWidth: 1,
            borderLineWidth: 0,             //Suvrat Issue#2817 to fix dashboard charts
        ...
        _renderChartLegend: function(V, C, S, v) {
            ...
            if (S) {
                ...
                $('#chartContainer1').find('.jqx-chart-title-text').each(function(){
                    $(this).html("Resource Matrix ( <a class='view_btn' href='/matrix' style='color:blue;cursor:pointer;text-decoration: none;outline: 0;'>View</a> )");   
                });
                $('#chartContainer').find('.jqx-chart-title-text').each(function(){
                    $(this).html("Projects ( <a class='view_btn' href='/dashboard-projects' style='cursor:pointer;color:blue;text-decoration: none;outline: 0;'>View</a> )");   
                });
                return E
            }
        },
        ...
        _renderAxis: function(H, D, Q, z, c, F, m, V, C, U, d) {
            ...
            var k = false;
            var j = 0;
            for (var S = 0; S < r.length && n.visible; S++,
            L += b) {
                if (!r[S] || isNaN(b)) {
                    continue
                }
        ...
        _renderLineSeries: function(k, R) {
            ...
            for (var n = I.series.length - 1; n >= 0; n--) {
                ...
                do {
                    ...
                    ai.segments.push(b)
                } while (V < D.xoffsets.first + D.xoffsets.length - 1 || u);this._linesRenderInfo[k][n] = ai
            }
        ...
        _calcInterval: function(d, j, h) {
            ...
            } while (l == g.length - 1);return g[l] * c
        },
